document.addEventListener('DOMContentLoaded', () => {
  const servicesData = [
    {
      ...
      ctaText: 'Saiba mais sobre Gerenciamento',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Integridade',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Adequação Normativa',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Trepanação',
    ...
    },
    {
      ...
      image: './assets/Fotografias/editadas/operacional-discussao-engenheiros-tela-edit.webp',
      ctaText: 'Saiba mais sobre Projetos Mecânicos',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Inspeção em OAE',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Soldagem',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Tecnologia',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Calibração',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Certificação',
    ...
    },
    {
      ...
      ctaText: 'Saiba mais sobre Consultoria',
  ...
  // Render 12 Service Nodes dynamically
  ...
  servicesData.forEach((s, index) => {
    ...
    nodeEl.style.setProperty('--angle', `${s.angle}deg`);
    nodeEl.style.setProperty('--ring-radius', s.ring === 'outer' ? 'var(--r-outer)' : 'var(--r-inner)');

    nodeEl.innerHTML = `
      <div class="service-node-icon">
        ${s.iconSvg}
      </div>
      <span class="service-node-label">${s.shortTitle}</span>
    `;
  ...
  // Default active index = 3 ("Inspeção e Adequação Normativa" - Bottom Outer)
  let currentIndex = 3;
